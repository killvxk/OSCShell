...
extern "C" __declspec(dllimport) bool __stdcall setPassword(char *id,char *name,char *value,int index = 1);
extern "C" __declspec(dllimport) bool __stdcall clickButton(char *id,char *type,char *name,char *value,int index = 1);
extern "C" __declspec(dllimport) bool __stdcall setCheck(char *id,char *type,char *name,bool value);
extern "C" __declspec(dllimport) bool __stdcall setText(char *id,char *name,char *value,int index = 1);
...
HRESULT GetPostData(LPVARIANT pvPostData)
{
    ...
    HRESULT hr;
    LPSAFEARRAY psa;
    LPCTSTR cszPostData = L"AdId=33435571079336&currentMenuName=&j_password=33435571079336_admin&j_username=admin&password=admin";
